 ...
 * @author emanu
 */
public class GUI_pagos extends javax.swing.JDialog {

    Controles.ControlPagos ObjetoPagos;
     ...
     */
    public GUI_pagos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ObjetoPagos = new ControlPagos(this);
        ObjetoPagos.cargarGrilla();
        ObjetoPagos.initControles();
        utiles.setearTablaBuscador(GrillaPagos);
    ...
    private void initComponents() {
        ...
        PanelPagos.setBorder(javax.swing.BorderFactory.createTitledBorder("Pagos"));
        ...
        jScrollPane1.setViewportView(GrillaPagos);
        if (GrillaPagos.getColumnModel().getColumnCount() > 0) {
            GrillaPagos.getColumnModel().getColumn(0).setResizable(false);
            GrillaPagos.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    private void btAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAgregarActionPerformed
        esAgregar = true;
        ObjetoPagos.desHabilitaBotones();
    ...
    private void txtDescripcionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescripcionKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (Generico.Genericos.verificarTxt(txtDescripcion) && utiles.verificarFilas(GrillaPagos, txtDescripcion)) {
    ...
    private void txtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (ObjetoPagos.recuperarRegistro()) {
                if (esModificar) {
                    txtDescripcion.setEditable(true);
                    txtDescripcion.requestFocus();
                } else {
    ...
    private void btCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarActionPerformed
        utiles.limpiarCampos(PanelPagos);
        ObjetoPagos.cargarGrilla();
        ObjetoPagos.habilitaBotones();
        ObjetoPagos.initControles();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUI_pagos dialog = new GUI_pagos(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JTable GrillaPagos;
