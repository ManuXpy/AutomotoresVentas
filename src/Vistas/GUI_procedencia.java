...
import Controles.ControlProcedencia;
 ...
 * @author emanu
 */
public class GUI_procedencia extends javax.swing.JDialog {

    Controles.ControlProcedencia ObjetoProcedencia;
     ...
     */
    public GUI_procedencia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ObjetoProcedencia = new ControlProcedencia(this);
        ObjetoProcedencia.cargarGrilla();
        ObjetoProcedencia.initControles();
        utiles.setearTablaBuscador(GrillaProcedencia);
    ...
    private void initComponents() {
        ...
        GrillaProcedencia = new javax.swing.JTable();
        ...
        PanelProcedencia.setBorder(javax.swing.BorderFactory.createTitledBorder("Procedencia"));
        ...
        PanelProcedenciaLayout.setHorizontalGroup(
            ...
            .addGroup(PanelProcedenciaLayout.createSequentialGroup()
                ...
                .addGap(45, 45, 45)
                .addGroup(PanelProcedenciaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        GrillaProcedencia.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(GrillaProcedencia);
        if (GrillaProcedencia.getColumnModel().getColumnCount() > 0) {
            GrillaProcedencia.getColumnModel().getColumn(0).setResizable(false);
            GrillaProcedencia.getColumnModel().getColumn(1).setResizable(false);
        }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(PanelProcedencia, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAgregarActionPerformed
        esAgregar = true;
        ObjetoProcedencia.desHabilitaBotones();
    ...
    private void txtDescripcionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescripcionKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (Generico.Genericos.verificarTxt(txtDescripcion) && utiles.verificarFilas(GrillaProcedencia, txtDescripcion)) {
    ...
    private void btGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGrabarActionPerformed
        if (esAgregar) {
            ObjetoProcedencia.alta();
        } else {
            ObjetoProcedencia.modificacion();
        }
        ObjetoProcedencia.initControles();
        btCancelar.doClick();
    ...
    private void txtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (ObjetoProcedencia.recuperarRegistro()) {
                if (esModificar) {
                    txtDescripcion.setEditable(true);
                    txtDescripcion.requestFocus();
                } else {
    ...
    private void btCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarActionPerformed
        utiles.limpiarCampos(PanelProcedencia);
        ObjetoProcedencia.cargarGrilla();
        ObjetoProcedencia.habilitaBotones();
        ObjetoProcedencia.initControles();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUI_procedencia dialog = new GUI_procedencia(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JTable GrillaProcedencia;
    public javax.swing.JPanel PanelProcedencia;
